...
public class DataSourceController implements DataSourceApi {
	...
	public static final String EVENT_REPORT = "/exceldatas/OutReach_Event_Information.xlsx";
	public static final String EVENT_SUMMARY = "/exceldatas/Outreach_Event_Summary.xlsx";
